...
The Urani Protocol then aggregates these intents into discrete batch auctions (rather than processing orders on a first-come, first-served basis - Solana's native method) and <strong>assigns them to <a href="https://docs.urani.trade/urani-swap/technical-considerations/mev-agent-operators" target="_blank">MEV Agents</a></strong>. 
