...
export default async function PageTermsAndConditions() {
  return (
    <div className="flex flex-col justify-between min-h-screen">
      ...
      <Container>
        <article className="flex flex-col justify-center mb-8 md:my-16 max-w-4xl m-auto lists">
          <div>
            <PostTitle>Terms and Conditions</PostTitle>
            <p className="my-8">Last updated: May 05, 2024</p>
            <h2 className="text-2xl my-4">Welcome to Urani!</h2>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Urani&apos;s Website, located at https://urani.trade.
            </p>
            <br />
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Urani if you do not agree to
            ...
            <p>
              ...
              &ldquo;Us&ldquo;, refers to our Company. &ldquo;Party&ldquo;,
              &ldquo;Parties&ldquo;, or &ldquo;Us&ldquo;, refers to both the
            ...
            <p>
              We employ the use of cookies. By accessing Urani, you agreed to
              use cookies in agreement with the Urani&apos;s Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Urani and/or its licensors own the
              intellectual property rights for all material on Urani. All
              intellectual property rights are reserved. You may access this
              from Urani for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Urani</li>
              <li>Sell, rent or sub-license material from Urani</li>
              <li>Reproduce, duplicate or copy material from Urani</li>
              <li>Redistribute content from Urani</li>
            </ul>
            ...
            <p>
              ...
              Urani does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of Urani,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Urani
            ...
            <p>
              Urani reserves the right to monitor all Comments and to remove any
            ...
            <p>
              You hereby grant Urani a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              Urani; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Urani. Please include your name, your
            ...
            <p>
              No use of Urani&apos;s logo or other artwork will be allowed for
...
export function generateMetadata(): Metadata {
  const title = `${CMS_NAME} | Privacy Terms`;
