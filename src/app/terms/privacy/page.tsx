...
export default async function PagePrivacyTerms() {
  return (
      ...
      <Container>
        <article className="flex flex-col justify-center mb-8 md:my-16 max-w-4xl m-auto lists">
          <div>
            ...
            <h2 className="text-2xl my-4">Interpretation and Definitions</h2>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Urani.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Urani, accessible from{" "}
                  <a
            ...
            <ul>
              <li>By email: hello@urani.trade</li>
            </ul>
          </div>
        </article>
      </Container>
