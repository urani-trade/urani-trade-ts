      ...
      <div className="max-w-screen-xl text-left text-purple m-auto">
        ...
        <ul className="px-6">
          ...
          <li className="mb-8">
            ...
            <b>Learn more <a href="https://docs.urani.trade/urani-protocol/urani-protocol-overview" target="_blank" rel="noopener noreferrer">here</a></b>.
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">
              ...
              <b>Learn more <a href="https://docs.urani.trade/urani-swap/overview" target="_blank" rel="noopener noreferrer">here</a></b>.
            </p>
          </li>
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">           
              ...
              <b>Learn more <a href="https://docs.urani.trade/mev-agents/the-onboarding-process" target="_blank" rel="noopener noreferrer">here</a></b>.
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">
              ...
              <b>Learn more <a href="https://docs.urani.trade/urani-arena/urani-arena-overview" target="_blank" rel="noopener noreferrer">here</a></b>.
