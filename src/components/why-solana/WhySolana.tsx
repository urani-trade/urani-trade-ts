      ...
      <div className="max-w-screen-xl text-left text-purple m-auto">
        ...
        <ul className="px-6">
          ...
          <li className="mb-8">
            ...
            On-chains agnostic orderbook conducting batch competitions among agents for the largest surplus, efficiency, and ingenuity. 
            The protocol provides various strategies to ensure users benefit from MEV protection and operators from all backgrounds 
            have opportunities to succeed - promoting fairness, accessibility, and meritocracy.
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">           
              MEV Agents are open-source algorithms (bots) for the Urani Protocol, allowing operators to integrate their preferred private strategies
              and start playing MEV e-games right away. Advanced strategies and AI-centric agents are the focus of research and development in our labs. 
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">
              The front interface and SDK facilitating the submission of order intents for consumption by the Urani Protocol, 
