      ...
      <div className="max-w-screen-xl text-left text-purple m-auto">
        ...
        <ul className="px-6">
          ...
          <li className="mb-8">
            ...
            The protocol provides various strategies to ensure fairness and meritocracy. 
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">
              ...
              <b><a href="https://docs.urani.trade/urani-swap/overview" target="_blank" rel="noopener noreferrer">  Learn more</a></b>.
            </p>
          </li>
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">           
              ...
              <b><a href="https://docs.urani.trade/mev-agents/the-onboarding-process" target="_blank" rel="noopener noreferrer">  Learn more</a></b>.
          ...
          <li className="mb-8">
            ...
            <p className="text-1xl md:text-2xl italic">
              ...
              <b><a href="https://docs.urani.trade/urani-arena/urani-arena-overview" target="_blank" rel="noopener noreferrer">  Learn more</a></b>.
