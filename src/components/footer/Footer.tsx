        ...
        <div className="flex flex-col-reverse sm:flex-row items-center justify-between">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm sm:text-base">
              <b>trade.different © urani.trade, 2024 </b>
            </span>
          </div>
            ...
            <div className="flex sm:justify-center items-center mb-8 sm:mb-0 ">
              ...
              >
                <span>
                 ...
                 <div className="flex sm:justify-between items-center mb-8 sm:mb-0 order-1">
              <a
                href="https://github.com/urani-trade"
                className="hover:text-decoration-line sm:ms-6"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
                  src="/logos/social-media/github.svg"
                  alt="GitHub Logo"
                  className="w-4 h-4"
                  width={20}
                  height={20}
