      ...
      <Flowbite theme={{ theme: customTheme }}>
        <Navbar fluid>
          <Navbar.Brand as={Link} href="/">
            <div className="relative flex w-full items-center justify-between">
              <Image
                ...
                src="/logos/space/space_logo_tiny.png"
                alt="Urani Logo"
                width={30}
                height={19}
                priority
          ...
          <Navbar.Collapse>
            ...
            <div className="relative group text-purple font-bold text-xl py-2 pl-3 pr-4 md:p-0">
              <Dropdown inline label="MEV Agents">
                <Dropdown.Item as={Link} href="/signup">
                  Sign Up for the Arena
                </Dropdown.Item>

                <Dropdown.Item as={Link} href="/mev-agent-templates">
                  MEV Agent Templates
                </Dropdown.Item>

                <Dropdown.Item as={Link} href="/operator-onboarding">
                  Operator Onboarding
                </Dropdown.Item>

                <Dropdown.Item as={Link} href="/cryptomarkets">
            ...
            <div className="relative group text-purple font-bold text-xl py-2 pl-3 pr-4 md:p-0">
              <Dropdown inline label="Learn">
                <Dropdown.Item as={Link} href="/mev">
                  Healthy and Toxic MEV
                </Dropdown.Item>
                <Dropdown.Item as={Link} href="/intents">
                  Orderflows and Intents
                </Dropdown.Item>
                <Dropdown.Item as={Link} href="/dev-onboarding">
            ...
            <Navbar.Link href="https://docs.urani.trade/" target="_blank">
              <div className="relative group text-purple font-bold text-xl">
                <span>Docs</span>
            ...
            <Navbar.Link href="https://uraniswap.vonsteinkirch.com" >
